...
public class SunECKeyLoader implements KeyLoader {
	...
	private final boolean defaultKeys;
	...
	//generated with domain parameter prime256v1
        ...
        private static final String DEFAULT_PKEY = "MD4CAQAwEAYHKoZIzj0CAQYFK4EEAAoEJzAlAgEBBCBnhIob4JXH+WpaNiL72BlbtUMAIBQoM852d+tKFBb7fg==";
        private static final String DEFAULT_UKEY = "MFYwEAYHKoZIzj0CAQYFK4EEAAoDQgAEavNEKGRcmB7u49alxowlwCi1s24ANOpOQ9UiFBxgqnO/RfOl3BJm0qE2IJgCnvL7XUetwj5C/8MnMWi9ux2aeQ==";
	...
	public PublicKey loadPublicKey(int id)
		...
		logger.trace("ID: {}, PublicKey Format: {}, PublicKey Algorithm: {} ",
                id, ret.getFormat(), ret.getAlgorithm());
		return ret;
	}
	...
	public PublicKey loadPublicKey()
		...
		logger.trace("ID: {}, PublicKey Format: {}, PublicKey Algorithm: {} ",
                this.id, ret.getFormat(), ret.getAlgorithm());
		return ret;
		...
		if (privateKey == null) {
			...
			try {
				...
				logger.trace("PrivateKey loaded for this.id: {}, "
                        ...
                        this.id, privateKey.getFormat(), privateKey.getAlgorithm());
			} catch (NoSuchProviderException e) {
				logger.error("Provider error.",e);
			}
		}
