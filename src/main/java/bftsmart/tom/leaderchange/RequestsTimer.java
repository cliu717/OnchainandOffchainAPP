...
public class RequestsTimer {
    ...
    private final Timer timer = new Timer("request timer");
    private RequestTimerTask rtTask = null;
    private final TOMLayer tomLayer; // TOM layer
    private final long timeout;
    private long shortTimeout;
    private final TreeSet<TOMMessage> watched = new TreeSet<TOMMessage>();
    private final ReentrantReadWriteLock rwLock = new ReentrantReadWriteLock();
    
    private boolean enabled = true;
    
    private final ServerCommunicationSystem communication; // Communication system between replicas
    private final ServerViewController controller; // Reconfiguration manager
    
    private final HashMap <Integer, Timer> stopTimers = new HashMap<>();
