...
public class DiskStateLog extends StateLog {
	...
	private final boolean syncLog;
	private String logPath;
	private String lastCkpPath;
	private final boolean syncCkp;
	private final boolean isToLog;
	private final ReentrantLock checkpointLock = new ReentrantLock();
	private final Map<Integer, Long> logPointers;
...
//			if (size > 0 && sendState) {
			if (size > 0) {
				...
				System.arraycopy(recoveredBatches, 0, batches, 0, size);
			}
