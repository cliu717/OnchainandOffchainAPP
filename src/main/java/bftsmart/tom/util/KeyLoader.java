...
public interface KeyLoader {
     ...
     */
    PublicKey loadPublicKey(int id) throws IOException, NoSuchAlgorithmException, InvalidKeySpecException, CertificateException;
     ...
     * @throws CertificateException If there was an error loading the public key certificate.
     */
    PublicKey loadPublicKey() throws IOException, NoSuchAlgorithmException, InvalidKeySpecException, CertificateException;
     ...
     * @throws InvalidKeySpecException If the key specs are not properly set .
     */
    PrivateKey loadPrivateKey() throws IOException, NoSuchAlgorithmException, InvalidKeySpecException;
